...
df_train = pd.read_csv('../data/train_subset.tsv', sep='\t', header=0)
...
x_train = bigram_vectorizer.fit_transform(df_train.commen
...
text_clf = grid_search.fit(x_train, df_train.label)
...
index = 0
f_out = open('../output/xgb_exp_1.csv', 'w')
